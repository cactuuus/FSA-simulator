<script lang="ts">
	...
	import { SimulationController } from '$lib/interaction';
...
{#if fsa.hasStackOps}
	<div
		class="absolute top-1/2 right-2 flex max-h-[80dvh] -translate-y-1/2 flex-col gap-1 overflow-y-auto rounded-box bg-base-100/95 p-2 shadow"
	>
