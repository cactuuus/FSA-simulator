...
{#if items.length > 0 && screenPos}
	<div
		...
		tabindex="-1"
		class="border-content max-w-90% absolute flex w-64 flex-col gap-2 rounded-r-box rounded-b-box border border-base-content/10 bg-base-100/90 text-sm shadow backdrop-blur-xs"
