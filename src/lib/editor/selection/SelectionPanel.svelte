...
{#if items.length > 0 && screenPos}
	<div
		...
		tabindex="-1"
		class="border-content max-w-90% absolute flex w-64 flex-col gap-2 rounded-r-box rounded-b-box border-2 bg-base-100/80 text-sm shadow backdrop-blur-xs"
	...
	>
		...
		<div
			role="toolbar"
			class="border-content flex items-center justify-between gap-2 border-b-2 p-2 hover:bg-base-content/5"
