...
export class ComputationTree {
	...
	readonly groups: ComputationNode[][];
	...
	/**
	 * Simple getter for the current group being processed, just there for convenience.
	 */
	get currentGroup(): ComputationNode[] {
